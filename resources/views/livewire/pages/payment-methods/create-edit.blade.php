<div>
    <div x-data="{ modalIsOpen: $wire.entangle('openModal').live }">
        <x-primary-button x-on:click="modalIsOpen = true">Crear método de pago</x-primary-button>
                ...
                <div
                    ...
                    <div class="flex flex-col items-start">
                        <h3 id="defaultModalTitle" class="font-semibold tracking-wide text-neutral-900 dark:text-white">
                            {{ $paymentMethodId ? 'Editar método de pago' : 'Crear método de pago' }}</h3>
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400  justify-self-start">
                            {{ $paymentMethodId ? 'Edita los datos del método de pago' : 'Ingresa los datos del método de pago' }}
                        </p>
                    </div>
                ...
                <div class="">
                    <form wire:submit="save" class="p-6">
                        ...
                        <div class="m-2 flex flex-col items-start gap-2">
                            <x-input-label for="name" value="Método de pago" />
